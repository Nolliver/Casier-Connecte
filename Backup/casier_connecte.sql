...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 24 nov. 2020 à 20:40
...
INSERT INTO `produits` (`id_produit`, `nom`, `nom_photo`, `id_sous_categ`) VALUES
(1, 'vis', 'vis.png', 1),
(2, 'Ecrou Nilstop', 'ecrou nylstop.jpg', 2),
(4, 'vis', 'vis.png', 1),
(3, 'vis', 'vis.png', 1);
...
INSERT INTO `quincaillerie` (`id_produit`, `type`, `longueur`, `utilite`, `pas`, `matiere`, `epaisseur`, `diametre`, `diametre_etrier`, `diametre_tube`, `diametre_int`, `diametre_ext`) VALUES
(1, 'tete fraisee', 15, 'bois', NULL, 'acier', NULL, 'M6', NULL, NULL, NULL, NULL),
(2, 'Nilstop', NULL, NULL, NULL, 'acier', 5, 'M6', NULL, NULL, NULL, NULL),
(3, 'tete CHC', 20, 'beton', NULL, 'acier', NULL, 'M3', NULL, NULL, NULL, NULL),
(4, 'tete hexagonale', 25, 'metal', NULL, 'nylon', NULL, 'M10', NULL, NULL, NULL, NULL);
...
(1, 'Vis', 'visCategorie.jpg'),
(2, 'Ecrou', 'ecrouCategorie.jpg');
